...
//
//  SGStreamSummaryLittleSnapCell.m
//  SeeGeek
//
...
#define IMAGE_WIDTH 60*SCREEN_SCALE
#define IMAGE_HEIGHT 90*SCREEN_SCALE

#define LOGO_IMAGE_WIDTH 30
#define LOGO_IMAGE_MARGIN_LEFT 10
#define LOGO_IMAGE_MARGIN_TOP 5

@interface SGStreamSummaryLittleSnapCell ()
...
@implementation SGStreamSummaryLittleSnapCell
...
- (void)updateConstraints {
    ...
    [self.logoImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.snapImageView.mas_right).offset(LOGO_IMAGE_MARGIN_LEFT);
